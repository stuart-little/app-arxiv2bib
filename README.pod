...
=head1 OPTIONS
    ...
    -n | --dry		only dump the the L<Mojo request object|https://docs.mojolicious.org/Mojo/Message/Request> your options have formed
    -v | --verbbose	dump the entire L<Mojo response object|https://docs.mojolicious.org/Mojo/Message/Response> you've received
